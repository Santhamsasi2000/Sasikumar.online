    ...
    <section className="hidden lg:block lg:p-7 xl:p-9 2xl:p-10 mt-20">
      <div className="flex flex-wrap justify-between">
        <div className="w-[55%] xl:w-[50%]">
          ...
          {/* Title */}
          <h1 className="text-5xl xl:text-6xl font-bold mb-3 sm:mb-5 font-neuton">
          ...
          {/* Subtitle */}
          <p className="text-gray-700 font-medium text-lg xl:text-xl mb-5">
            {subtitle}
          </p>
        ...
        <div className="w-[45%] xl:w-[40%]">
           <LazyLoadImage src="/images/Home/HeroCTA/hero-img-5.jpg" className=""/>
        </div>
